...
* Gill's ordering of the components from left to right opposite of how they occur temporally: Processes [lead to]{style="color: magenta;"} Impacts [lead to]{style="color: magenta;"} which [lead to]{style="color: magenta;"} Outcomes.
...
![](assets/img/coherent_infographic_1.png){width=100%}
